...
export const createUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    const { status, success, message, data } = await userService.createUser(name, email);
    if (success) {
...
export const updateUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    const { status, success, message, data } = await userService.updateUser(userId, name, email, role, req.body.status);
