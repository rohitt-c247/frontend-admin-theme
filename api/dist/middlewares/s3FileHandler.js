...
exports.uploadFileS3 = exports.s3UploadMiddleware = void 0;
...
const s3File_handler_1 = require("../utils/s3File.handler");
/**
 ...
 */
exports.s3UploadMiddleware = (0, multer_1.default)({
    storage: s3File_handler_1.s3Storage,
    limits: {
        ...
        (0, exports.s3UploadMiddleware)(req, res, (error) => {
            if (error) {
                ...
                if (error.code === _constants_1.fileHandlerVariables.ENOENT_ERROR_CODE) {
                    return next(new _utils_2.ErrorHandler(`${_constants_1.fileHandlerMessages.DIRECTORY_FOUND_ERROR} ${error.field}.`, 400, error));
                }
                if (error.code === _constants_1.fileHandlerVariables.LIMIT_UNEXPECTED_FILE_ERROR_CODE) {
                    return next(new _utils_2.ErrorHandler(`${_constants_1.fileHandlerMessages.FILE_UPLOAD_LIMIT_ERROR} ${_constants_1.fileHandlerVariables.FILE_UPLOAD_LIMIT}`, 400, error));
                }
                if (error.name === 'Error') {
...
//# sourceMappingURL=s3FileHandler.js.map